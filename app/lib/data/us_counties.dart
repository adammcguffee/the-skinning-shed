/// US Counties data - organized by state.
/// For MVP, includes complete county lists for key hunting states.
/// Full dataset can be loaded from Supabase for production.
class USCounties {
  USCounties._();

  /// Get counties for a state by abbreviation
  static List<String> forState(String stateCode) {
    return _countiesByState[stateCode.toUpperCase()] ?? [];
  }

  /// Check if we have county data for a state
  static bool hasCountiesFor(String stateCode) {
    return _countiesByState.containsKey(stateCode.toUpperCase());
  }

  /// All states with county data
  static List<String> get availableStates => _countiesByState.keys.toList();

  // County data by state (comprehensive for key hunting/fishing states)
  static const Map<String, List<String>> _countiesByState = {
    'AL': _alabamaCounties,
    'AK': _alaskaCounties,
    'AZ': _arizonaCounties,
    'AR': _arkansasCounties,
    'CA': _californiaCounties,
    'CO': _coloradoCounties,
    'CT': _connecticutCounties,
    'DE': _delawareCounties,
    'FL': _floridaCounties,
    'GA': _georgiaCounties,
    'HI': _hawaiiCounties,
    'ID': _idahoCounties,
    'IL': _illinoisCounties,
    'IN': _indianaCounties,
    'IA': _iowaCounties,
    'KS': _kansasCounties,
    'KY': _kentuckyCounties,
    'LA': _louisianaCounties,
    'ME': _maineCounties,
    'MD': _marylandCounties,
    'MA': _massachusettsCounties,
    'MI': _michiganCounties,
    'MN': _minnesotaCounties,
    'MS': _mississippiCounties,
    'MO': _missouriCounties,
    'MT': _montanaCounties,
    'NE': _nebraskaCounties,
    'NV': _nevadaCounties,
    'NH': _newHampshireCounties,
    'NJ': _newJerseyCounties,
    'NM': _newMexicoCounties,
    'NY': _newYorkCounties,
    'NC': _northCarolinaCounties,
    'ND': _northDakotaCounties,
    'OH': _ohioCounties,
    'OK': _oklahomaCounties,
    'OR': _oregonCounties,
    'PA': _pennsylvaniaCounties,
    'RI': _rhodeIslandCounties,
    'SC': _southCarolinaCounties,
    'SD': _southDakotaCounties,
    'TN': _tennesseeCounties,
    'TX': _texasCounties,
    'UT': _utahCounties,
    'VT': _vermontCounties,
    'VA': _virginiaCounties,
    'WA': _washingtonCounties,
    'WV': _westVirginiaCounties,
    'WI': _wisconsinCounties,
    'WY': _wyomingCounties,
  };

  // Alabama (67 counties)
  static const _alabamaCounties = [
  ...
  static const _alaskaCounties = [
    ...
    'Sitka', 'Skagway', 'Southeast Fairbanks', 'Valdez-Cordova', 'Wrangell',
    'Yakutat', 'Yukon-Koyukuk',
  ];

  // Arizona (15 counties)
  static const _arizonaCounties = [
  ...
  static const _arkansasCounties = [
  ...
  static const _californiaCounties = [
  ...
  static const _coloradoCounties = [
  ...
  static const _connecticutCounties = [
    'Fairfield', 'Hartford', 'Litchfield', 'Middlesex', 'New Haven',
    'New London', 'Tolland', 'Windham',
  ];

  // Delaware (3 counties)
  static const _delawareCounties = ['Kent', 'New Castle', 'Sussex'];

  // Florida (67 counties)
  static const _floridaCounties = [
  ...
  static const _georgiaCounties = [
    ...
    'Effingham', 'Elbert', 'Emanuel', 'Evans', 'Fannin', 'Fayette', 'Floyd',
    'Forsyth', 'Franklin', 'Fulton', 'Gilmer', 'Glascock', 'Glynn', 'Gordon',
  ...
  // Hawaii (5 counties)
  static const _hawaiiCounties = [
    'Hawaii', 'Honolulu', 'Kalawao', 'Kauai', 'Maui',
  ];

  // Idaho (44 counties)
  static const _idahoCounties = [
  ...
  static const _illinoisCounties = [
  ...
  static const _indianaCounties = [
    ...
    'Tipton', 'Union', 'Vanderburgh', 'Vermillion', 'Vigo', 'Wabash', 'Warren',
    'Warrick', 'Washington', 'Wayne', 'Wells', 'White', 'Whitley',
  ];

  // Iowa (99 counties)
  static const _iowaCounties = [
  ...
  static const _kentuckyCounties = [
  ...
  static const _louisianaCounties = [
  ...
  static const _massachusettsCounties = [
  ...
  static const _michiganCounties = [
    ...
    'Sanilac', 'Schoolcraft', 'Shiawassee', 'St. Clair', 'St. Joseph', 'Tuscola',
    'Van Buren', 'Washtenaw', 'Wayne', 'Wexford',
  ];

  // Minnesota (87 counties)
  static const _minnesotaCounties = [
  ...
  static const _mississippiCounties = [
  ...
  static const _missouriCounties = [
  ...
  static const _nebraskaCounties = [
    'Adams', 'Antelope', 'Arthur', 'Banner', 'Blaine', 'Boone', 'Box Butte',
    'Boyd', 'Brown', 'Buffalo', 'Burt', 'Butler', 'Cass', 'Cedar', 'Chase',
    'Cherry', 'Cheyenne', 'Clay', 'Colfax', 'Cuming', 'Custer', 'Dakota', 'Dawes',
    'Dawson', 'Deuel', 'Dixon', 'Dodge', 'Douglas', 'Dundy', 'Fillmore', 'Franklin',
  ...
  static const _newMexicoCounties = [
  ...
  static const _northCarolinaCounties = [
  ...
  static const _northDakotaCounties = [
    ...
    'Sioux', 'Slope', 'Stark', 'Steele', 'Stutsman', 'Towner', 'Traill', 'Walsh',
    'Ward', 'Wells', 'Williams',
  ];

  // Ohio (88 counties)
  static const _ohioCounties = [
  ...
  static const _oklahomaCounties = [
  ...
  static const _pennsylvaniaCounties = [
  ...
  static const _rhodeIslandCounties = [
    'Bristol', 'Kent', 'Newport', 'Providence', 'Washington',
  ];

  // South Carolina (46 counties)
  static const _southCarolinaCounties = [
  ...
  static const _southDakotaCounties = [
    ...
    'Kingsbury', 'Lake', 'Lawrence', 'Lincoln', 'Lyman', 'Marshall', 'McCook',
  ...
  static const _tennesseeCounties = [
  ...
  static const _texasCounties = [
    ...
    'Hale', 'Hall', 'Hamilton', 'Hansford', 'Hardeman', 'Hardin', 'Harris',
    'Harrison', 'Hartley', 'Haskell', 'Hays', 'Hemphill', 'Henderson', 'Hidalgo',
    'Hill', 'Hockley', 'Hood', 'Hopkins', 'Houston', 'Howard', 'Hudspeth', 'Hunt',
    'Hutchinson', 'Irion', 'Jack', 'Jackson', 'Jasper', 'Jeff Davis', 'Jefferson',
    'Jim Hogg', 'Jim Wells', 'Johnson', 'Jones', 'Karnes', 'Kaufman', 'Kendall',
    'Kenedy', 'Kent', 'Kerr', 'Kimble', 'King', 'Kinney', 'Kleberg', 'Knox',
    'La Salle', 'Lamar', 'Lamb', 'Lampasas', 'Lavaca', 'Lee', 'Leon', 'Liberty',
  ...
  static const _virginiaCounties = [
  ...
  static const _washingtonCounties = [
  ...
  static const _westVirginiaCounties = [
  ...
  static const _wisconsinCounties = [
